  ...
  return (
    <div id="about" className="about-container">
      ...
      <div className="answer">
        I'm a project manager-turned-software engineer, defying the norms and taking the leap into the captivating realm of coding. Embracing the challenge, I've traded spreadsheets for lines of code, adding a dash of tech wizardry to my repertoire.
      </div>
      ...
      <div className="answer">
        ...
        <br></br>
        <br></br>
        I have spent the last year with a small team of engineers at DemandJump, converting legacy code into a fast single-page app using React, Node, Express, and Typescript. We increased the speed of the website by 94% as well as delivered far more intuitive useabilit
      </div>
